...
1. ZQ220+向けの日本語フォントはプレインストールされている。
...
<tr>
    <th>Image</th>
    <th width=300>Part Number</th>
    <th width=300>Description</th>
    <th width=300>Compatible Printers</th>
</tr>

<tr>
   <td><img height=100 src="./images/CHG-MPV-SNGBC1-01.jpg"></td>
    <td>CHG-MPV-SNGBC1-01</td>
    <td>Single Battery Charger (AC to USB adapter + USB cable)</td>
    <td>ZQ220, ZQ220 Plus, ZQ120, ZQ120 Plus, ZR138</td>
</tr>

<tr>
   <td><img height=100 src="./images/CBL-MPM-USB1.jpeg"></td>
    <td>CBL-MPM-USB1-01</td>
    <td>USB Type A to Type C cable</td>
    <td>ZQ210, ZQ220, ZQ220 Plus</td>
</tr>
...
<tr>
   <td><img height=100 src="./images/SG-MPV-SC31-01.jpeg"></td>
    <td>SG-MPV-SC31-01</td>
    <td>Soft Case with Shoulder Strap</td>
    <td>ZQ220, ZQ220 Plus</td>
</tr>

<tr>
   <td><img height=100 src="./images/KIT-MPM-BLTCLP5-01.jpeg"></td>
    <td>KIT-MPM-BLTCLP5-01</td>
    <td>Belt Clip (5 pack)</td>
    <td>ZQ220, ZQ220 Plus</td>
</tr>
...
<tr>
   <td><img height=100 src="./images/KIT-MPV-MD3SPR1-5.jpeg"></td>
    <td>KIT-MPV-MD3SPR1-5</td>
    <td>Media Spacer (for 3", 2.3", 2" paper)</td>
    <td>ZQ220, ZQ220 Plus</td>
</tr>
